                ...
                <div className="fixed top-0 left-0 z-50 w-full h-full bg-black bg-opacity-75 flex justify-center items-center">
                    <div className="bg-white p-4 rounded-lg">
                        <div className="flex justify-between items-center mb-2">
                            <a href={link} target="_blank" rel="noreferrer" className="bg-gray-400 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-lg shadow-lg transition duration-300 ease-in-out no-underline uppercase flex items-center">
                            ...
                            <a href={code} target="_blank" rel="noreferrer" className="bg-gray-400  hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-lg shadow-lg transition duration-300 ease-in-out no-underline uppercase flex items-center">
