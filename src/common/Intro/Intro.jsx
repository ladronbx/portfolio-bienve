    ...
    return (
        <div className="intro-style text-white">
            ...
            <div className="text-xl text-green-100 mt-2">
                ...
                <p>En 2022 dejé mi trabajo en una multinacional como administrativa y me lancé a estudiar programación. Desde entonces, me he dedicado a especializarme en el desarrollo de software.</p>
